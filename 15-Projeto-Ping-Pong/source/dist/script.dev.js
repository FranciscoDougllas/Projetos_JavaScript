...
var score = {
  human: 0,
  computer: 0,
  increaseHuman: function increaseHuman() {
    this.human++;
  },
  increaseComputer: function increaseComputer() {
    this.computer++;
  },
  draw: function draw() {
...
var ball = {
  ...
  directionX: 1,
  directionY: 1,
  _calcPosition: function _calcPosition() {
  ...
  _reverseX: function _reverseX() {
    // 1 * -1 = -1
    // -1 * -1 = 1
    this.directionX *= -1;
  },
  _reverseY: function _reverseY() {
    // 1 * -1 = -1
    // -1 * -1 = 1
    this.directionY *= -1;
  },
